...
write_csv(apartment_building_registry, here::here("data-raw", "points_layers", "apartment_building_registry", "extract", glue::glue("{Sys.Date()}-apartment_building_registry.csv")))
