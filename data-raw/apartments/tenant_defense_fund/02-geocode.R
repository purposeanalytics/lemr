...
tenant_defense_fund <- readRDS(here::here("data-raw", "apartments", "tenant_defense_fund", "extract", "tenant_defense_fund.rds"))
...
# Save
saveRDS(tenant_defense_fund_address_geocoded, here::here("data-raw", "apartments", "tenant_defense_fund", "geocode", "tenant_defense_fund.rds"))
