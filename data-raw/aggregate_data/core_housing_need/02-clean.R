...
core_housing_need_cts <- readRDS(here::here("data-raw", "core_housing_need", "extract", "core_housing_need.rds"))
households_tested_for_chn_cts <- readRDS(here::here("data-raw", "core_housing_need", "extract", "households_tested_for_chn.rds"))
...
### Save data ----
saveRDS(core_housing_need_joined, here::here("data-raw", "core_housing_need", "clean", "core_housing_need.rds"))
