...
cts_census_path <- here::here("data-raw", "rental_supply", "census_custom_tab_2016_table1", "raw", "TorontoCT_geography_structuraltype_condominium_tenure_Table1.csv")
...
saveRDS(toronto_cts, here::here("data-raw", "rental_supply", "census_custom_tab_2016_table1", "extract", "custom_tab_toronto_table1.rds"))
