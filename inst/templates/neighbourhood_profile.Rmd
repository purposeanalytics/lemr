...
```{r population-change, opts.label = "distribution", fig.alt = lemur:::number_of_apartments_plot_alt_text(level, neighbourhood)}
...
lemur:::number_of_apartments_plot(dataset, compare)
```
