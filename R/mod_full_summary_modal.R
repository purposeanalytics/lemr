        ...
        shiny::fluidRow(
          shiny::column(
            ...
            shiny::div(
              ...
              shiny::hr(),
              shiny::h3("Renter household size (2016)"),
              ...
              shiny::hr(),
              shiny::h3("Average renter household total income (2016)"),
