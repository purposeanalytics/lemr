  ...
  shiny::tagList(
    ...
    shiny::div(
      ...
      shiny::div(
        ...
        shiny::p("LEMR assembles datasets related to the loss of units and displacement of people from the low-end of market and uses automation to process and link them together. Taken together, these datasets provide policy makers, housing advocates, and researchers with insight into the dynamics of the low-end of the market, enabling them to make better decisions around the supply and preservation of this stock."),
        ...
        shiny::p("Important Note: In this proof of concept, the \"estimated availability of low-end of market rental units\" data is from a dummy dataset. Datasets that were critical to creating a data-driven estimate were not available in time, so the dummy dataset is provided for demonstration purposes and should not be used to make conclusions or decisions about the supply of deeply affordable housing in Toronto. All other datasets presented in the proof of concept are real and from authoritative sources.")
      ),
      shiny::div(
