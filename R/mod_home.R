  ...
  shiny::tagList(
    ...
    shiny::div(
      ...
      shiny::div(
        ...
        shiny::p(shiny::HTML("The project team recognizes that, in addition to the pressing issue of displacement that people who rely on the low-end of market housing face, there is the inescapable history of the displacement of Indigenous Peoples that also occurred on these lands, inflicting harm that continues to reverberate today. We further acknowledge that this project is hosted on the traditional lands of the Mississaugas of the Credit, the Anishinaabek, the Chippewa, the Haudenosaunee, and the Wendat peoples.")),
        shiny::h3("About Us"),
