...
apartment_building_registry is a geocoded version of the City of Toronto's [Apartment Building Registration Dataset](https://open.toronto.ca/dataset/apartment-building-registration/), with cleaned addresses, neighbourhoods, and latitude and longitude:
...
using `display_neighbourhood_profile()` to compare breakdowns, either in a plot:
...
The field `geo_id` can be used to connect with some other City of Toronto data sets, in order to look up the latitude and longitude for an address.
