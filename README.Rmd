...
[LEMR](https://app.lemr.ca/shiny/) is an interactive tool developed to understand changes in the supply of deeply affordable rental housing in the City of Toronto.

LEMR was developed by [Purpose Analytics](https://purposeanalytics.ca/) as a short-listed project through the Canada Mortgage Housing Corporation's Housing Supply Challenge Data Driven Round.
