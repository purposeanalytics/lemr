...
ggplot(pos_tab_prop_plot %>% filter(Stock > 1937) %>% arrange(top3), aes(y = LEMProp, x = HighMedium, colour = top3)) + 
  ...
  scale_y_continuous(labels = scales::percent, limits = c(0, .3), name = "a ylabel") + 
  scale_x_continuous(labels = scales::percent, limits = c(0, 1), name = "an xlabel") + 
